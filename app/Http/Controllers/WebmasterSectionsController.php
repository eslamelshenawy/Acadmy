...
class WebmasterSectionsController extends Controller
{
    ...
    public function courses()
    {
        ...
        return view("backEnd.courses.courses", compact("WebmasterSections", "GeneralWebmasterSections"));
    }

    /**
     * Display a listing of create the courses.
     *
     * @return \Illuminate\Http\Response
     */
    public function create_courses()
    {
        ...
        return view("backEnd.courses.create", compact("WebmasterSections", "GeneralWebmasterSections"));
    }
    ...
    public function books()
    {
        ...
        return view("backEnd.books.books", compact("WebmasterSections", "GeneralWebmasterSections"));
    }
...
// Fields Functions
    ...
    function fieldsEdit($webmasterId, $field_id)
    {
        ...
        if (count($WebmasterSection) > 0) {
            ...
            if (count($WebmasterSectionField) > 0) {
                return redirect()->action('WebmasterSectionsController@edit', [$webmasterId])->with('activeTab',

            ...
            <div class="tab-content clear b-t">
                ...
                icons: {
                  ...
                  <span class="fa fa-calendar"></span>
                        ...
                        @endif
                        @if($WebmasterSection->price =="1")
                        <div class="form-group row">
                            <label for="price"
                                   class="col-sm-2 form-control-label">{{trans('backLang.prices') }}
                            </label>
                            <div class="col-sm-10">
                              <input placeholder="{{trans('backLang.prices') }}"value="{{ $Topics->prices }}" class="form-control"  required="" dir="ltr" name="prices" type="text" value="">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="hours"
                            ...
                            <div class="col-sm-10">
                              <input placeholder="{{trans('backLang.hours') }}"value="{{ $Topics->hours }}" class="form-control"  required="" dir="ltr" name="hours" type="text" value="">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="week"
                            ...
                            <div class="col-sm-10">
                              <input placeholder="{{trans('backLang.week') }}" value="{{ $Topics->weeks }}" class="form-control"  required="" dir="ltr" name="week" type="text" value="">
                            </div>
                        </div>
                      @endif
                    ...
                    @endif
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control"  name="select_year" id="select_year">
                              <option>{{trans('backLang.select_year') }}</option>
                              <!-- <option value="{{ $Topics->year }}"{{$Topics->year == $Topics->year ? "selected" : "" }}>{{ $Topics->year }}</option> -->
...
@section('footerInclude')
    ...
    $('#select_year')
    .find('[value={{ $Topics->year }}]').attr("selected", "selected");
//     // .remove()
//     // .end()
//     .append('<option value="{{ $Topics->year }}"{{$Topics->year == $Topics->year ? "selected" : "" }}>{{ $Topics->year }}</option>')
//     // .val('{{ $Topics->year }}')
// ;
        $(function () {

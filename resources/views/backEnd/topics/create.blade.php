            ...
            <div class="box-body">
                ...
                @endif
                  ...
                  <div class="form-group row">
                      ...
                      <div class="col-sm-10">
                        <input placeholder="{{trans('backLang.prices') }}" class="form-control"  required="" dir="ltr" name="prices" type="text" value="">
                      </div>
                  </div>
                  <div class="form-group row">
                      <label for="title_en"
                      ...
                      <div class="col-sm-10">
                        <input placeholder="{{trans('backLang.hours') }}" class="form-control"  required="" dir="ltr" name="hours" type="text" value="">
                      </div>
                  </div>
                  <div class="form-group row">
                      <label for="title_en"
                      ...
                      <div class="col-sm-10">
                        <input placeholder="{{trans('backLang.week') }}" class="form-control"  required="" dir="ltr" name="week" type="text" value="">
                      </div>
                  </div>
                @endif
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <input placeholder="{{trans('backLang.arabic_name') }}" class="form-control"  required="" dir="ltr" name="name_ar" type="text" value="">
                    </div>
                </div>
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <input placeholder="{{trans('backLang.english_name') }}" class="form-control"  required="" dir="ltr" name="name_en" type="text" value="">
                    </div>
                </div>
              @endif

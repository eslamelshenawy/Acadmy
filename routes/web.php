...
//category of books
Route::get('books', 'WebmasterSectionsController@books')->name('WebmasterSections');
Route::get('create/books', 'WebmasterSectionsController@create_books')->name('WebmasterSections');
Route::post('store/books', 'WebmasterSectionsController@store_books')->name('WebmasterSections');
Route::get('edit/books/{id}', 'WebmasterSectionsController@edit_books')->name('WebmasterSections');
Route::get('delete/books/{id}', 'WebmasterSectionsController@delete_books')->name('WebmasterSections');
